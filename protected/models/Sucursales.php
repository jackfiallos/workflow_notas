...
/**
 * This is the model class for table "catSucursales".
 *
 * The followings are the available columns in table 'catSucursales':
 * @property integer $id
...
class Sucursales extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('codigo', 'unique', 'message'=>'Este c&oacute;digo est&aacute; siendo utilizado por otra Sucursal'),
			array('codigo, nombre, clientes_codigo', 'required', 'message' => '<strong>{attribute}</strong> es un campo requerido'),
			...
			array('id, nombre, editable, codigo, clientes_codigo', 'safe', 'on'=>'search'),
		);
	}
