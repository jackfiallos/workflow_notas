...
/**
 * This is the model class for table "tblCooperacion".
 *
 * The followings are the available columns in table 'tblCooperacion':
 * @property integer $id
 * @property string $importe
 * @property integer $mes_aplicacion
 * @property integer $notas_id
 */
class Cooperacion extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'marcas' => array(self::MANY_MANY, 'Marcas', 'catMarcas_has_cooperacion(cooperacion_id, marcas_id)'),
			'cmarcas' => array(self::HAS_MANY, 'MarcasHasCooperacion', 'cooperacion_id'),
			'notas' => array(self::BELONGS_TO, 'Notas', 'notas_id'),
		);
	}
	 ...
	 * @return Cooperacion the static model class
	 */
