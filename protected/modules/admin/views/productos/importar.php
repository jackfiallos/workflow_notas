...
<div class="pageheader notab">
    <h1 class="pagetitle">Importar archivo de productos</h1>
    <span class="pagedesc">Importar archivo de productos</span>
    <div class="pull-right" style="margin: 0 10px;">
		<a href="<?php echo Yii::app()->createUrl('admin/productos/index'); ?>" class="button-large button-secondary pure-button"><i class="fa fa-home"></i> Regresar</a>
	</div>
</div>
<div id="contentwrapper" class="contentwrapper">
	...
	<?php if(Yii::app()->user->hasFlash('Productos.Error')):?>
		<div class="notibar msgerror">
            <a class="close"></a>
            <p><?php echo Yii::app()->user->getFlash('Productos.Error'); ?></p>
        </div>
	<?php endif; ?>
	...
	<div class="form-actions" style="text-align:right; margin-top:20px">
		...
		<a href="<?php echo Yii::app()->createUrl('admin/productos/index'); ?>" class="button-large button-secondary pure-button">Cancelar</a>
	</div>
	<?php $this->endWidget(); ?>
</div>