...
<div class="pageheader notab">
    <h1 class="pagetitle">Importar archivo de marcas</h1>
    <span class="pagedesc">Importar archivo de marcas</span>
...
<div id="contentwrapper" class="contentwrapper">
	...
	<?php if(Yii::app()->user->hasFlash('Marcas.Error')):?>
		<div class="notibar msgerror">
            <a class="close"></a>
            <p><?php echo Yii::app()->user->getFlash('Marcas.Error'); ?></p>
        </div>
	<?php endif; ?>
	...
	<div class="form-actions" style="text-align:right; margin-top:20px">
		...
		<a href="<?php echo Yii::app()->createUrl('admin/marcas/index'); ?>" class="button-large button-secondary pure-button">Cancelar</a>
	</div>
	<?php $this->endWidget(); ?>
</div>