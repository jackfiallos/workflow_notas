...
<div class="pageheader notab">
    <h1 class="pagetitle">Crear nuevo registro de cliente</h1>
    <span class="pagedesc">Crear nuevo registro de cliente</span>
	...
	<div class="pure-g" style="margin-bottom:20px">
		...
		<div class="pure-u-2-5">
			<div class="control-group <?php echo (strlen($form->error($model,'empresa'))>0) ? 'error' : null; ?>">
				...
				<div class="controls">
					<?php echo $form->listBox($model, 'empresa', array(), array('multiple'=>'multiple', 'style'=> 'width:100%; height:125px;')); ?>
					<span class="help-inline">
