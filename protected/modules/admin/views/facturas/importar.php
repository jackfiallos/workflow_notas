...
<div class="pageheader notab">
    <h1 class="pagetitle">Importar archivo de facturas</h1>
    <span class="pagedesc">Importar archivo de facturas</span>
    <div class="pull-right" style="margin: 0 10px;">
		<a href="<?php echo Yii::app()->createUrl('admin/facturas/index'); ?>" class="button-large button-secondary pure-button"><i class="fa fa-home"></i> Regresar</a>
	</div>
</div>
<div id="contentwrapper" class="contentwrapper">
	...
	<?php if(Yii::app()->user->hasFlash('Facturas.Error')):?>
		<div class="notibar msgerror">
            <a class="close"></a>
            <p><?php echo Yii::app()->user->getFlash('Facturas.Error'); ?></p>
        </div>
	<?php endif; ?>
	...
	<div class="form-actions" style="text-align:right; margin-top:20px">
		...
		<a href="<?php echo Yii::app()->createUrl('admin/facturas/index'); ?>" class="button-large button-secondary pure-button">Cancelar</a>
	</div>
	<?php $this->endWidget(); ?>
</div>