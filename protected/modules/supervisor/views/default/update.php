...
<div class="pageheader notab">
	...
	<div class="pull-right" style="margin: 0 10px; float:right">
		...
		<a href="<?php echo Yii::app()->createUrl('supervisor/default/pendientes'); ?>" class="button-large button-secondary pure-button"><i class="fa fa-home"></i> Regresar</a>
	</div>
</div>
<div id="contentwrapper" class="contentwrapper">
	...
	<?php if(Yii::app()->user->hasFlash('Supervisor.Success')):?>
		<div class="notibar msgsuccess">
            <a class="close"></a>
            <p><?php echo Yii::app()->user->getFlash('Supervisor.Guardar'); ?></p>
        </div>
	<?php endif; ?>

	<?php if(Yii::app()->user->hasFlash('Supervisor.Error')):?>
		<div class="notibar msgerror">
            <a class="close"></a>
            <p><?php echo Yii::app()->user->getFlash('Supervisor.Error'); ?></p>
        </div>
	<?php endif; ?>

	<?php if(Yii::app()->user->hasFlash('Supervisor.Warning')):?>
		<div class="notibar msgalert">
            <a class="close"></a>
            <p><?php echo Yii::app()->user->getFlash('Supervisor.Warning'); ?></p>
        </div>
	<?php endif; ?>
	...
	<?php if($puedeEditarNota): ?>
		...
		<div class="pure-g">
	    	<div class="pure-u-5-5">
				...
				<div class="control-group <?php echo (!is_null($model->getError('estatus')) ? 'error' : ''); ?>">
		            <div class="controls">
		                <?php  echo $form->radioButtonList($model, 'estatus', array( 
		        ...
		        <div class="control-group <?php echo (!is_null($model->getError('comentario')) ? 'error' : ''); ?>">
		            ...
		            <div class="controls">
						<?php echo $form->textArea($model, 'comentario', 
								array('class'=>'validar','rows' => 6, 'cols' => 50,'maxlength' => 300)); 
						?>
						 <span class="help-inline">
		...
		<div class="form-actions" style="text-align:right; margin-top:20px">
    		<button id="boton_form"class="button-large pure-button-primary pure-button" type="submit" name="yt0" value="Guardar" disabled="disabled">Guardar</button>
    		<a href="<?php echo Yii::app()->createUrl('supervisor/default/revisar')?>" class="button-large button-secondary pure-button">Regresar</a>
		</div>
		<?php $this->endWidget(); ?>
	<?php endif; ?>
...
$cs->registerScript('solicitudesAprobar.jquery.main', "
	...
	$(document).on('change', '.validar[type=radio]', function(e){
		...
		if( $('.validar[type=radio]').is(':checked') && 
			$('#SolicitudesAprobarForm_comentario').val() !== '' ){
