   ...
   function drawPieLegend($X,$Y,$Format="")
    {
     ...
     $numColors= 0; //Parche (xine)
     foreach($Data["Series"][$Data["Abscissa"]]["Data"] as $Key => $Value)
      {
       //Parche para corregir error de mas de 7 elementos  
       if($numColors>7){
          $numColors=0;
       }

       $R = $Palette[$numColors]["R"]; $G = $Palette[$numColors]["G"]; $B = $Palette[$numColors]["B"];
