$(document).ready(function() {
	...
	$(document).click(function(event) {
		...
		if(!$(event.target).is('.userinfodrop') && !$(event.target).is('.userdata') && ud.is(':visible')) {
			ud.hide();
			$('.userinfo').removeClass('active');
		}
	...
	$(document).on('click', '.notitab a', function(){
	...
	$(document).on('click', '.hornav a', function(e) {
		//e.preventDefault();
