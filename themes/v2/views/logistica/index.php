...
<div id="contentwrapper" class="contentwrapper">
	<?php if(Yii::app()->user->hasFlash('Logistica.Success')):?>
		<div class="notibar msgsuccess">
            <a class="close"></a>
            <p><?php echo Yii::app()->user->getFlash('Logistica.Success'); ?></p>
        </div>
	<?php endif; ?>
	...
	<?php if(Yii::app()->user->hasFlash('Logistica.Warning')):?>
		<div class="notibar msgalert">
            <a class="close"></a>
            <p><?php echo Yii::app()->user->getFlash('Logistica.Warning'); ?></p>
        </div>
	<?php endif; ?>
	...
	<?php $this->widget('zii.widgets.grid.CGridView', array(
	    'id'=>'aprobadores-grid',
	    'dataProvider'=>$model->searchDevoluciones(),
