...
<div class="pageheader notab">
	...
	<div class="pull-right" style="margin: 0 10px; float:right">
		...
		<a href="<?php echo Yii::app()->createUrl('aprobadores/index'); ?>" class="button-large button-secondary pure-button"><i class="fa fa-home"></i> Regresar</a>
	</div>
</div>
<div id="contentwrapper" class="contentwrapper">
	...
	<?php if(Yii::app()->user->hasFlash('Aprobadores.Success')):?>
		<div class="notibar msgsuccess">
            <a class="close"></a>
            <p><?php echo Yii::app()->user->getFlash('Aprobadores.Guardar'); ?></p>
        </div>
	<?php endif; ?>
